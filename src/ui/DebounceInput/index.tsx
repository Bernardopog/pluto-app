    ...
    <div className='flex flex-col'>
      ...
      <div className='relative w-full'>
        <input
          ...
          name={name ?? id}
          id={id}
          className='peer w-full p-1 pr-10 rounded-lg border-2 border-transparent outline-none bg-chetwode-blue-200 text-chetwode-blue-900 duration-300 ease-in-out focus:border-chetwode-blue-600 dark:bg-chetwode-blue-700 dark:text-chetwode-blue-50'
